# <img src="https://raw.githubusercontent.com/Midori-Dragon/furaffinity-archive/refs/heads/main/assets/icons/icon.svg" height="30"> Furaffinity Features
...
[![Firefox users](https://img.shields.io/amo/users/furaffinity-archive?label=firefox%20users&color=ff7139&logo=firefox-browser)](https://addons.mozilla.org/firefox/addon/furaffinity-archive/)
[![Greasy Fork users](https://img.shields.io/greasyfork/dt/543793?label=greasyfork%20users&logo=greasyfork)](https://greasyfork.org/scripts/543793-furaffinity-archive)
[![Release](https://img.shields.io/github/v/release/Midori-Dragon/furaffinity-archive?label=Release&color=2ea44f&logo=github)](https://github.com/Midori-Dragon/furaffinity-archive/releases/latest)
[![Issues](https://img.shields.io/github/issues/Midori-Dragon/furaffinity-archive?label=Issues&color=e4a000&logo=github)](https://github.com/Midori-Dragon/furaffinity-archive/issues)
...
- [Chrome Web Store](https://chromewebstore.google.com/detail/furaffinity-archive/dedddeinlepdkegmhnlggepfoeakikmc)
- [Firefox Add-ons](https://addons.mozilla.org/firefox/addon/furaffinity-archive/)
...
All feature and library modules are also bundled together as a single combined userscript — [Furaffinity Features](https://greasyfork.org/en/users/967324-midori-tsume) — available on GreasyFork. See the [docs](./docs/furaffinity-archive/README.md) for details.
...
1. Install from [Chrome Web Store](https://chromewebstore.google.com/detail/furaffinity-archive/dedddeinlepdkegmhnlggepfoeakikmc) / [Firefox Add-ons](https://addons.mozilla.org/firefox/addon/furaffinity-archive/)
...
Visit the [docs](https://midori-dragon.github.io/furaffinity-archive/) for a more detailed description.
...
```bash
git clone https://github.com/MidoriDragon/furaffinity-archive.git
```

```bash
cd furaffinity-archive
```
...
[!["Buy me a coffee"](https://raw.githubusercontent.com/Midori-Dragon/furaffinity-archive/refs/heads/main/assets/meta/orange-button-x180.png)](https://www.buymeacoffee.com/midori_dragon)
